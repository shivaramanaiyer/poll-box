...
<script>
      window.fbAsyncInit = function() {
        ...
        FB.Event.subscribe('auth.login', function(response) {
          window.location = "./activity_page.php"
        });
        FB.Event.subscribe('auth.logout', function(response) {
          window.location="http://localhost/finale/poll-box/voteweb/login.php";
        });
      };
      (function() {
...
<div id="slider-wrapper">
    ...
    $(window).load(function() {
	  ...
	  <table><tr><th>
        <tr><th>Browser Compatible</th><th><a href="aboutus.html" target="blank">About us</a></th><th><a href="contactus.html" target="blank">Contact Us</a></th></tr></tr><tr><th><img src="chrome.png"><img src="mozilla.png"></th></tr></table>
	    </div>
