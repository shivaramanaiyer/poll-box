...
<div class="hero-unit0">
<h1><b><?PHP echo "&nbsp;&nbsp;&nbsp; Welcome ". $user_profile['name'];?></b>
</h1>
<div class="bar"></div>
...
<h1>Create your poll</h1>       
       ...
       <table>
		<tr>
		 ...
		 <tr><td><br /></td></tr>
         <tr>
          <td><b>Poll Title*:</b></td><td><input type="text" name="title" class="input-xlarge" onBlur="validate_title()" id="poll_title" size="25"></td>
         </tr>
		 <tr><td><br /></td></tr>
         <tr>
            <td><b>Poll Description*:</b></td> <td> <textarea rows="3" name="description" class="input-xlarge" onBlur="validate_des()" cols="40" id="poll_des"></textarea><input type="hidden" id="poll_des_type" name="des_content_type" value="text"></td>
         </tr>
         <tr><td><br /></td></tr>
		 
		 <tr>
            <td><b>Expiry Date:</b></td><td><input name="poll_expiry_date" type="text" id="poll_expiry_date" class="input-xlarge" size="12" readonly /> </td>
         </tr>
         <tr><td><br /></td></tr>
		 <tr>
            <td><b>Tags:</b></td><td> <textarea rows="2" name="tags" cols="30" id="poll_tags" class="input-xlarge"></textarea></td>
         </tr>
        
		  <tr><td>&nbsp;</td><td></td></tr>
              
          <tr><td><b>Upload Options: </b>
              <input type="hidden" name="options_type" id="options_type" class="input-xlarge" value="text">
              <input type="hidden" name="total_op" id="total_option" value="2"></td><td>
		  <div id="option_text_block" class="unhide_block"><h2>Text Option:</h2><span>Option 1: <input type="text" name="o1" id="option1" class="input-xlarge"><br>Option 2: <input type="text" name="o2" id="option2" class="input-xlarge"><br/></span><a href="#" onClick="add_text_option()">Add Another Option</a><br/><br/><a href="#" onClick="unhideBlock('option_image_block')">Or Add Image</a></div>
          </td></tr>
          ...
          <tr><td><br /></td></tr>
            <tr><td>
              <input type="submit" class="btn btn-primary" onClick="send_data()" name="CreatePoll" value="Create Poll">
              </td></tr>
</br>			  
    </table>  
		...
		if ( validate_op() && validate() && validate_title() && validate_des()== 1)
	{
		...
		var obj = {who : fbuser , expiry_date : document.getElementById('poll_expiry_date').value,visibility : "public",
	...
	function add_text_option()
	{
		...
		newInput.className = "input-xlarge";
